...
using Playground.IdentityServer.STS.Identity.Configuration;
using Playground.IdentityServer.STS.Identity.Configuration.ApplicationParts;
...
using Playground.IdentityServer.STS.Identity.Helpers.Localization;

namespace Playground.IdentityServer.STS.Identity.Helpers
{

...
using BN.CleanArchitecture.Infrastructure.PipelineBehaviors;
...
namespace BN.CleanArchitecture.Infrastructure;
...
public static class InfrastructureExtensions
{
        ...
        Type apiAnchorType, Action<IServiceCollection> doMoreActions = null)
    {
        ...
        // TODO: Implement the below services, Darp related
    ...
    public static IApplicationBuilder UseAppCore(this WebApplication app, IWebHostEnvironment env)
    {
        ...
        app.UseCors("api");
        app.UseRouting();
        // app.UseCloudEvents(); // Darp Implementation

        app.UseEndpoints(endpoints =>
        {
            // endpoints.MapSubscribeHandler(); // Darp Implementation
